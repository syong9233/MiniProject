...
public class ControllerManager {
	...
	//***************************DataAccessQuest DAO*************************************
	public void questChoice(ActionEvent e, JLabel ingTap, JLabel goalTap,JLabel ingMoney, JLabel goalMoney){
		quest.qChoice(e, main.getMain(), ingTap, goalTap, ingMoney, goalMoney);
	}
	//------------------------------------------------------------------------------------
